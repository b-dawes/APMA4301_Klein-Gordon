...
def f_k(t,kx,ky,kz,d):
        ...
        if d == 1:
            if t <= 20*h:
                return -4*1j*pi*kx*np.exp(-0.1*(kx**2+ky**2+kz**2))*0.1/(1+np.exp(-0.25*(t/h-10)))*np.exp(-kx*0.2*pi*1j*cos(2*pi*0.1*t)-ky*0.2*pi*1j*sin(2*pi*0.1*t))
            return -4*1j*pi*kx*np.exp(-0.1*(kx**2+ky**2+kz**2))*0.1*np.exp(-kx*0.2*pi*1j*cos(2*pi*0.1*t)-ky*0.2*pi*1j*sin(2*pi*0.1*t))
            
        if d == 2:
            if t <= 20*h:
                return -4*1j*pi*ky*np.exp(-0.1*(kx**2+ky**2+kz**2))*0.1/(1+np.exp(-0.25*(t/h-10)))*np.exp(-kx*0.2*pi*1j*cos(2*pi*0.1*t)-ky*0.2*pi*1j*sin(2*pi*0.1*t))
            return -4*1j*pi*ky*np.exp(-0.1*(kx**2+ky**2+kz**2))*0.1*np.exp(-kx*0.2*pi*1j*cos(2*pi*0.1*t)-ky*0.2*pi*1j*sin(2*pi*0.1*t))
